          ...
          <div class="event-container">
            <div class="card event-card">
              ...
              <div class="event-footer">
                <p style={{backgroundColor: "#e48e2c"}}>Concert</p>
                <div class="btn-group">
            ...
            <div class="card event-card">
              ...
              <div class="event-footer">
                <p style={{backgroundColor: "#582bac"}}>Workshop</p>
                <div class="btn-group">
                  <button>Buy Ticket</button>
                  <div class="share">
                    <button class="share-btn">
            ...
            <div class="card event-card">
              ...
              <div class="event-footer">
                <p style={{backgroundColor: "#b31a4d"}}>Theatre</p>
                <div class="btn-group">
                  <button>Buy Ticket</button>
                  <div class="share">
                    <button class="share-btn">
            ...
            <div class="card event-card">
              ...
              <div class="event-footer">
                <p style={{backgroundColor: "#4a920f"}}>Sport</p>
                <div class="btn-group">
                  <button>Buy Ticket</button>
                  <div class="share">
                    <button class="share-btn">

        ...
        >
            ...
            <div className="max-w-7xl mx-auto py-12">
                <div className="max-w-7xl px-4 sm:px-6 sm:px-6 lg:px-8">
                    ...
                    <div className="px-4 sm:px-6 bg-white overflow-hidden shadow-sm sm:rounded-lg mb-4 w-max p-4">
                        <h2 className="text-indigo-500">Lessons:</h2>
                    </div>
                    {lessons.data.length  > 0 ?
                    (
                        <ul className="px-4 sm:px-6 text-green-500 font-bold bg-white overflow-hidden shadow-sm sm:rounded-lg w-max p-4">
                    ...
                    : 
                    <p className="px-4 sm:px-6 bg-white overflow-hidden shadow-sm sm:rounded-lg mb-4 w-max p-4 text-indigo-500">No lessons yet</p>
                    }

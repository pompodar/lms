            ...
            <div className="max-w-7xl mx-auto py-12">
                <div className="max-w-7xl px-4 sm:px-6 sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-4 w-max">
                        ...
                        {courses.data.length ? courses.data.map((course, index) => (
                            <ul className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                                <li key={course.id}>
                                    <Link href={route('courses.show', course.id)} className="p-6 block text-green-500 hover:text-green-600 font-bold">{index + 1}. {course.title} </Link>
                                </li>
                            </ul>
                        ))
                        :
